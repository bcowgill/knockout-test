...
// Useful for automatic ignore of items that have been 'destroyed' by setting _destroy = true within them
...
if (!window.jQuery) {
    console.warn("jQuery missing, knockout.js binding handler extensions fallback to plain visible/hidden instead of animation.");
    ...
    ko.bindingHandlers.hidden = {
        ...
        update: function(element, valueAccessor) {
            ...
            var shouldHide = valueAccessor();
            shouldHide ? $(element).fadeOut() : $(element).fadeIn();
        }
    };
